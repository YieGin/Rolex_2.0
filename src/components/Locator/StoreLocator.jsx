...
const StoreLocator = (props) => {
  ...
  return (
    <div id={props.theme} className="Store_main">
      <h1>{t("Locator.page4.1")}</h1>
      <h1> {t("Locator.page4.2")}</h1>
      ...
      <div style={{ display: " flex", columnGap: " 10px", width: "36%" }}>
        <svg
          height="20"
          width="20"
          fill="green"
        ...
        <p style={{ paddingBottom: "20%" }}>{t("Search.page3.jeweler")}</p>
      </div>
      <h2 style={{ color: "rgb(18, 120, 74)", paddingBottom: "1%" }}>
        {t("Locator.page4.3")}
      </h2>
      <img className="Image_map" src={Image21} alt="" />
      <div className="necessary">
        <h1>{t("Locator.page4.4")}</h1>
        <h1>{t("Locator.page4.5")}</h1>
        <h1>{t("Locator.page4.6")}</h1>
      </div>
      <div className="necessaryy">
        <p>{t("Locator.page4.7")}</p>
        <p>{t("Locator.page4.8")}</p>
        <p>{t("Locator.page4.9")}</p>
      </div>
      <div>
        <img
          className="Image22"
